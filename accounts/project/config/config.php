...
if(((!isset($_SESSION['change_password_required'])) || $_SESSION['change_password_required']=='Y' ) && !in_array(basename($_SERVER['PHP_SELF']),array("ForceChangePassword_basic.php","logout.php") ) ){
    $redirect = "Location:";

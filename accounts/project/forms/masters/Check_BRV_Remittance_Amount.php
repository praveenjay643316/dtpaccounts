...
?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(document).on('click', '#showdatewisetable', function() {
                    $("#datewisetable").show()
                });
        ...
        <div class="card">
                    ...
                    <table class="table table-bordered text-center table-striped tndtp_report_table" id="dataTable2">
                        <thead class="text-left">
                            <tr>
                                ...
                                <th scope="col"><span DisplayLabelID="329">Month</span></th>
                                <th scope="col"><span DisplayLabelID="186">OB Amount</span></th>
                                <th scope="col"><span DisplayLabelID="671">Triplicate Amount</span></th>
                                <th scope="col"><span DisplayLabelID="388">BRV Amount</span></th>
                        ...
                        <tbody id="tradedetails_data">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-left"><a href="#" id="showdatewisetable">
                                        ...
                                        <td class="text-left">
                                            <?php echo htmlentities($sel_tradedetails_details_row['description_ta']); ?>
                                        </td>
                                        <td class="text-left">
                                            <?php echo htmlentities($sel_tradedetails_details_row['traderate']); ?>
                                        </td>
                                    </tr>
                                <?php
                                }
            ...
            <div class="card" style="display: none;" id="datewisetable">
                <div class="card-body">

                    <div class="single-table">
                        <table class="table table-bordered text-center table-striped tndtp_report_table" style="width:100%;" id="dataTable">
                            <thead class="text-left">
                                <tr>
                                    <th scope="col"><span DisplayLabelID="311">S.No</span></th>

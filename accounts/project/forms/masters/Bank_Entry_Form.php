...
class BankEntry_Master_Form  extends ConfigClass
{
    ...
    public $page_token = "bank_entry_form";
    ...
    public function main_content($post_data_array = array())
    {
        ...
        if (isset($_GET["edit_id"]) || isset($_GET["del_id"])) {
            if (isset($_GET["edit_id"])) {
                $exemption_category_data_id = base64_decode($_GET["edit_id"]);
            } else if (isset($_GET["del_id"])) {
                $exemption_category_data_id = base64_decode($_GET["del_id"]);
            }
        ...
        <form action="Bank_Entry_Form.php" method="post" enctype="multipart/form-data"  autocomplete="off">
            ...
            <input class="form-control form-control-sm" type="hidden" id="edit_id" name="edit_id" value="<?php echo htmlentities(isset($post_data_array["edit_id"])?base64_decode($post_data_array["edit_id"]):''); ?>">
            <input class="form-control form-control-sm" type="hidden" id="del_id" name="del_id" value="<?php echo htmlentities(isset($post_data_array["del_id"])?base64_decode($post_data_array["del_id"]):''); ?>">
            <div class="col-md-12">
            <div class="card">
                <div class="card-body pl-5 pr-5">
                    ...
                    <table class="table table-bordered m-0 p-0 table-striped tndtp_report_table">
                        ...
                        <tbody>
                            <tr>
                                <td style="width:50%;"><span><?php echo htmlentities('Bank Code '); ?></span></td>
                                <td>
                                    <input type="text" id="bank_code" name="bank_code" class="form-control w-50 form-control-sm name_eng_without_space w-50 "  value="<?php 
                                    if (isset($post_data_array['bank_code']))
                                    {
                                        echo htmlentities($post_data_array['bank_code']);
                                    }
                                    else if (isset($data_array_val['bank_code'])) {
                            ...
                            <tr>
                                <td style="width:50%;"><spanBank Name In English ><?php echo htmlentities('Bank Name In English'); ?></span></td>
                                <td>
                                    <input type="text" id="bank_name_en" name="bank_name_en" value="<?php 
                                    if (isset($post_data_array['bank_name_en']))                                   {
                                        echo htmlentities($post_data_array['bank_name_en']);    
                                    }
                                    else if(isset($data_array_val['bank_name_en']) )
                                   {
                                    echo htmlentities($data_array_val['bank_name_en']);    
                                   } 
                                    ?>" class="form-control form-control-sm name_eng_with_space w-50" />
                                </td>
                            </tr>

                            <tr>
                                <td style="width:50%;"><span><?php echo htmlentities('Bank Name In Tamil '); ?></span></td>
                                <td>
                                    <input type="text" id="bank_name_ta" name="bank_name_ta" value="<?php 
                                    if (isset($post_data_array['bank_name_ta']))
                                    {
                                        echo htmlentities($post_data_array['bank_name_ta']);    
                                    }
                                    else if(isset($data_array_val['bank_name_ta']))
                                    {
                                        echo htmlentities($data_array_val['bank_name_ta']);
                                    }
                                    ?>" class="form-control form-control-sm name_tamil w-50" />
                                </td>
                            </tr>
...
<?php
    ...
    public function data_save($save_data)
    {
        ...
        if (isset($save_data["edit_id"]) && $save_data["edit_id"]!=0) {
        ...
        } else if (isset($save_data["del_id"]) && $save_data["del_id"]!=0) {
